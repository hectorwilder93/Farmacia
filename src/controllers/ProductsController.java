    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == views.btn_register_product){
            if(views.txt_product_code.getText().equals("")
                ...
                JOptionPane.showMessageDialog(null, "Todos los campos son obligatorios wilder");
            }else{
                ...
                if(productDao.registerProductQuery(product)){
                    JOptionPane.showMessageDialog(null, "Producto registrado con exito wilder");
                }else{
                    JOptionPane.showMessageDialog(null, "Ha ocurrido un error al registrar al producto wilder");
                }
            }
        }
    }
