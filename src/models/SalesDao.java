...
public class SalesDao {
    ...
    //Obtener el id maximo de la venta
    public int saleId(){
        int id = 0;
    ...
    public List listAllSalesQuery(){
        List list_sales = new ArrayList();
        
        String query = "SELECT s.id AS invoice, c.full_name AS customers, e.full_name AS employee, s.total, s.sale_date FROM sales s"
